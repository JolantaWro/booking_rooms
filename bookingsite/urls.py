...
from booking_app.views import AddRoomView, ShowAllRooms, ShowDetails, ModifyRoom, DeleteRoom, ReserveRoom, SearchRoom
...
urlpatterns = [
    ...
    path('search/', SearchRoom.as_view(), name='search_room'),
]
